  ...
  return (
    <div className="admin-tab">
      ...
      <div className="admin-screen">
        ...
        <p className="admin-tab__lead">
          Для проектора в актовом зале или телевизора в холле: клумба во весь экран, крупный счётчик
          и объявления о каждом новом цветке — камера сама показывает его крупно.
        </p>
