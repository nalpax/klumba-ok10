...
await p.screenshot({path:'/tmp/m_admin_event.png'});
...
await p.mouse.wheel(0, 500); await p.waitForTimeout(200);
await p.screenshot({path:'/tmp/m_admin_form_sticky.png'});
...
await p.screenshot({path:'/tmp/m_admin_blocked.png'});
